export declare const onTicketCreate: import("inngest").InngestFunction<Omit<import("inngest").InngestFunction.Options<import("inngest").Inngest<{
    id: string;
...
//# sourceMappingURL=on-ticket-create.d.ts.map